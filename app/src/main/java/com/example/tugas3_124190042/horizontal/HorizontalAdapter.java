...
public class HorizontalAdapter extends RecyclerView.Adapter<HorizontalAdapter.ViewHolder> {
    ...
    public HorizontalAdapter(ArrayList<MotorModel> motorList, Context context) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            ivMotor = itemView.findViewById(R.id.iv_horizontal_item_image);
            tvMotor = itemView.findViewById(R.id.tv_horizontal_item_title);
        }
